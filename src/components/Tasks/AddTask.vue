          ...
          <div class="shadow form-section">
            ...
            <form method="post">
              ...
              <select v-model="selectedCategory" class="custom-select mt-3">
                <option :selected="selectedCategory">{{selectedCategory.name}}</option>
                <option v-for="category in categories">{{category.name}}</option>
              </select>
              <div v-show="files.length<1" class="not-selected-input mt-3">
                <b>Файлы</b>
                <div class="form-group">
                  <input @change="inputChange()" type="file" name="file" id="file" class="input-file" multiple="true">
  ...
  methods: {
    ...
    addFiles(id) {
      ...
      for (let file of filesList) {
        ...
        $.ajax({
          url: this.$store.getters.get_url_server + "api/v1/file/",
          data: formData,
          processData: false,
          contentType: false,
          type: "POST",
...
<style>
.not-selected-input .btn-tertiary{color:#555;padding:0;line-height:40px;width:300px;margin:auto;display:block;border:2px solid #555}
.not-selected-input .btn-tertiary:hover,.not-selected-input .btn-tertiary:focus{color:#888;border-color:#888}
.not-selected-input .input-file{width:.1px;height:.1px;opacity:0;overflow:hidden;position:absolute;z-index:-1}
.not-selected-input .input-file + .js-labelFile{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:0 10px;cursor:pointer}
.not-selected-input .input-file + .js-labelFile .icon:before{content:"\f093"}
.not-selected-input .input-file + .js-labelFile.has-file .icon:before{content:"\f00c";color:#5AAC7B}

.selected-input .btn-tertiary{color:#ffc107;padding:0;line-height:40px;width:300px;margin:auto;display:block;border:2px solid #ffc107}
.selected-input .btn-tertiary:hover,.not-selected-input .btn-tertiary:focus{color:#f8d56b;border-color:#f8d56b}
.selected-input .input-file{width:.1px;height:.1px;opacity:0;overflow:hidden;position:absolute;z-index:-1}
.selected-input .input-file + .js-labelFile{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:0 10px;cursor:pointer}
.selected-input .input-file + .js-labelFile .icon:before{content:"\f093"}
.selected-input .input-file + .js-labelFile.has-file .icon:before{content:"\f00c";color:#5AAC7B}
.b {
  color: #ff0000;
}
.ul {
